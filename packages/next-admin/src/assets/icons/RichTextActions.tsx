...
export const Heading = ({
  ...
  className,
  ...props
}: React.SVGAttributes<SVGElement> & { level: 1 | 2 | 3 }) => {
  const numberPath = {
  ...
  return (
    <svg
      ...
      viewBox="0 0 915 512"
    >
      <path d="M0 36.5714C0 16.3429 16.3429 0 36.5714 0H91.4286H146.286C166.514 0 182.857 16.3429 182.857 36.5714C182.857 56.8 166.514 73.1429 146.286 73.1429H128V201.143H384V73.1429H365.714C345.486 73.1429 329.143 56.8 329.143 36.5714C329.143 16.3429 345.486 0 365.714 0H420.571H475.429C495.657 0 512 16.3429 512 36.5714C512 56.8 495.657 73.1429 475.429 73.1429H457.143V237.714V438.857H475.429C495.657 438.857 512 455.2 512 475.429C512 495.657 495.657 512 475.429 512H420.571H365.714C345.486 512 329.143 495.657 329.143 475.429C329.143 455.2 345.486 438.857 365.714 438.857H384V274.286H128V438.857H146.286C166.514 438.857 182.857 455.2 182.857 475.429C182.857 495.657 166.514 512 146.286 512H91.4286H36.5714C16.3429 512 0 495.657 0 475.429C0 455.2 16.3429 438.857 36.5714 438.857H54.8571V237.714V73.1429H36.5714C16.3429 73.1429 0 56.8 0 36.5714Z" />
      <path d={numberPath[level]} />
    </svg>
  );
};
