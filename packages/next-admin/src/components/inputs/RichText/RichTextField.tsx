    ...
    <Slate editor={editor} initialValue={initialValue} onChange={handleChange}>
      ...
      <EditorContainer>
        <Toolbar>
          ...
          <Button format="underline" icon={<Icons.Underline />} title="Underline" />
          <Button format="strikethrough" icon={<Icons.Strikethrough />} title="Strikethrough" />
          <Button format="code" icon={<Icons.Code />} title="Code" />
          <Separator />
          <Button format="blockquote" icon={<Icons.Quote />} title="Blockquote" />
          <Button format="bulleted-list" icon={<Icons.BullettedList />} title="Bulleted list" />
          <Button format="numbered-list" icon={<Icons.NumberedList />} title="Numbered list" />
          <Separator />
          <Button format='heading-one' icon={<Icons.Heading level={1} />} title='Heading 1' />
          <Button format='heading-two' icon={<Icons.Heading level={2} />} title='Heading 2' />
          <Button format='heading-three' icon={<Icons.Heading level={3} />} title='Heading 3' />
        </Toolbar>
        <Editable
          spellCheck
