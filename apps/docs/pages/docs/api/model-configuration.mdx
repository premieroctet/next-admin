...
To configure your models, you can use the `model` property of the [NextAdmin options](/docs/api/next-admin-options).
...
<OptionsTable
      options={[
        ...
        },
        {
          name: "list",
          type: "Object",
          description: <>an object containing the list options (see <a href="#list-property">below</a>)</>
        },
        {
          name: "edit",
          type: "Object",
          description: <>an object containing the edit options (see <a href="#edit-property">below</a>)</>
        },
        {
          name: "actions",
          type: "Array",
...
<OptionsTable 
  options={[
    ...
    },
    {
      name: "filters",
      type: "Array",
      description: "define a set of Prisma filters that user can choose in list",
    },
    {
      name: "exports",
      type: "Object",
      description: "an object or array of export - containing export url",
    },
  ]}
/>
<Callout type="info">
    ...
    <OptionsTable
      options={[
        ...
        },
        {
          name: "handler.upload",
          type: "Function",
          description: <>an async function that is used only for formats `file` and `data-url`. It takes a Buffer object and and informations object containing `name` and `type` property as parameter and must return a string. Useful to upload a file to a remote provider</>,
        },
        {
...
If you pass a Notice object in the `display` array of the `edit` property of a model, it will be displayed in the form. 
...
Here is an example of using the `notice` property:
...
![Notice example](/docs/notice-example.png)
