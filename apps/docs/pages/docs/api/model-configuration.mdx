...
The `fields` property is an object that can take the following properties:
  ...
  options={[
        {
          name: "formatter",
          type: "Function",
          description: <>a function that takes the field value as a parameter, and that return a JSX node. It also accepts a second argument which is the <a href="#nextadmin-context">NextAdmin context</a></>,
        },
        {
          name: "sortBy",
          type: "String",
...
The `fields` property can take the following:
