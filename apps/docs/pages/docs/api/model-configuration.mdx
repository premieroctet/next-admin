...
The `filters` property allow you to define a set of [Prisma filters](https://www.prisma.io/docs/orm/prisma-client/queries/filtering-and-sorting) that users can apply on the [list view](/docs/glossary#list-view). It's an array of the following object:
...
The `exports` property allows you to define a set of export actions that users can apply on the [list view](/docs/glossary#list-view).
...
Represents the context that is passed to the formatter function in the [list.fields](#modelnameeditfields--modelnamelistfields-property) property.
<OptionsTable
  options={[
    {
      name: "locale",
