...
<OptionsTable
      options={[
        ...
        {
          name: 'model',
          description: 'Object to custom model and fields names. [More details](#translate-model-name-and-fields)',
          defaultValue: '{}',
        },
  ]}
/>
...
<Callout type="info">
  If you only use one language for your admin, you should prefer to use the `alias` system ([more details](/docs/api-docs#model)) to customize field names.
</Callout>
