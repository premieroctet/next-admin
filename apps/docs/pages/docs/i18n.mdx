...
There is two ways to translate these default keys, provide a function named `getMessagesFunc` inside the options or provide `translations` props to `NextAdmin` component.
