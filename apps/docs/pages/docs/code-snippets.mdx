...
export async function POST(req: NextRequest, context: any) {
  ...
  if (context.params.nextadmin[1] === "new") {
...
Then, if you want that route to be available on the sidebar, you can add a new route - [more info](/docs/api-docs#pages):
