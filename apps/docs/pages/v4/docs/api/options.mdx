...
```
--- 
The `NextAdminOptions` type is an object that can take the following properties:
...
The `sidebar` property allows you to customize the aspect of the sidebar menu. It is an object that can take the following properties:
